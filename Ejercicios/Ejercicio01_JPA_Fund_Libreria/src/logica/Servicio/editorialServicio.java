...
import logica.Persistencia.EditorialJpaController;
...
public class editorialServicio {
    ...
    public void crearEditorialBD() throws Exception {
        try {
            Editorial a = cargaEditorial();
            cp.crearEditorialBD(a);
        } catch (Exception e) {
            throw e;
        }
    }
    ...
    public void eliminarEditorial() throws Exception {
        ...
        cp.eliminarEditorialBD(id);

    }

    public void mostrarEditorial() {
        List<Editorial> liblist = cp.obtenerEditoriales();
    ...
    public Editorial obtenerEditorial(String id) {
        Editorial editorial = cp.obtenerEditorial(id);
        return editorial;
    }
    ...
    public Editorial ModificarEditorial() {
        try {
            ...
            String id = leer.next();
            Editorial e = cp.obtenerEditorial(id);
